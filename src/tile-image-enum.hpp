    ...
    */
    constexpr TileImage charToTileImage(const char ch) noexcept
    {
        ...
        switch (ch)
        {
            ...
            case '\x8B': { return TileImage::WailingCreeper;        }
    ...
    constexpr char tileImageToChar(const TileImage t_image) noexcept
    {
        ...
        switch (t_image)
        {
            ...
            case TileImage::WailingCreeper:      { return '\x8B'; }
    ...
    constexpr bool isTileImageNpc(const TileImage t_image) noexcept
    {
        return (
            ...
            (t_image == TileImage::Elfman) || (t_image == TileImage::Dwarf) ||
            (t_image == TileImage::Wiglaf) || (t_image == TileImage::Human) ||
            (t_image == TileImage::RedKnight) || (t_image == TileImage::Elf) ||
            (t_image == TileImage::ElfWarrior) || (t_image == TileImage::GreenElf) ||
            (t_image == TileImage::GreenElfMage) || (t_image == TileImage::BlueClown) ||
            (t_image == TileImage::BlueKnight) || (t_image == TileImage::Spartan) ||
            (t_image == TileImage::Satyr) || (t_image == TileImage::GoldKnight) ||
            (t_image == TileImage::DeepCaster) || (t_image == TileImage::OldMan) ||
            (t_image == TileImage::GoldClown) || (t_image == TileImage::Hag) ||
            (t_image == TileImage::CyanKnight) || (t_image == TileImage::Elfnee) ||
            (t_image == TileImage::Javelinee) || (t_image == TileImage::SkullSpeaker) ||
            (t_image == TileImage::FolkMage) || (t_image == TileImage::Maud) ||
    ...
    inline const sf::IntRect tileImageToRect(const TileImage tileImage) noexcept
    {
        ...
        switch (tileImage)
        {
            ...
            case TileImage::WailingCreeper:     { return sf::IntRect( {352, 32},{32,32}); }
